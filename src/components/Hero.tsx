    ...
    return (
        <div ref={ref} className="relative h-screen w-full overflow-hidden flex flex-col items-center justify-center">
            ...
            >
                ...
                <img src="/seen.jpg" alt="SEEN" className="w-full h-full object-cover grayscale-[30%] contrast-110" />
            </motion.div>
                ...
                >
                    ...
                    <div className="flex items-center gap-4 md:gap-6 mt-2">
                        ...
                        >
                            ...
                            <span className="relative z-10 font-mono text-xs md:text-sm font-bold tracking-widest text-white group-hover:text-[#4FFFB0] transition-colors">
                                [ X ]
                            </span>
                        </a>
                        ...
                        <a
                            href="#"
                            className="group relative px-8 py-3 bg-[#4FFFB0] border border-[#4FFFB0] hover:bg-[#4FFFB0]/90 transition-all duration-300 shadow-[0_0_20px_rgba(79,255,176,0.3)] hover:shadow-[0_0_30px_rgba(79,255,176,0.5)]"
                        >
            ...
            <motion.div
                ...
                className="absolute bottom-0 left-0 w-full z-20 px-10 md:px-48 pb-8 pt-24 bg-gradient-to-t from-black via-black/80 to-transparent"
            >
